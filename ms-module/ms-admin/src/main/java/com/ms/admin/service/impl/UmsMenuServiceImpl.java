...
import com.ms.admin.mapper.UmsMenuMapper;
...
public class UmsMenuServiceImpl implements UmsMenuService {
    ...
    public IPage<UmsMenu> list(Long parentId, Integer pageSize, Integer pageNum) {
        ...
        IPage<UmsMenu> page = new Page<>(pageNum, 10);

        return menuMapper.selectPage(page, new QueryWrapper<UmsMenu>().eq("parent_id", parentId).orderByDesc("sort"));
    }

    @Override
    public List<UmsMenuNode> treeList() {
        List<UmsMenu> menuList = menuMapper.selectList(new QueryWrapper<>());
